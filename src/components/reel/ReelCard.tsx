...
export default function ReelCard({ reel, height = "h-[100vh]", onCelebrate }: ReelCardProps) {
  ...
  return (
    <div className={cn("reel-container", height) + " absolute"} style={{ marginTop: "-5rem" }}>
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/70">
        <div className="absolute bottom-5 left-0 right-0 p-4 sm:p-6 text-white">
